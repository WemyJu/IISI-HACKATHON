...
//		mDaoMaster = new DaoMaster(db);
        ...
        mSharedPreferences = getSharedPreferences(Constants.PREFERENCE_NAME, 0);
...
//		}
        ...
        mSharedPreferences.edit().putBoolean("NeedToUpdateSignActivity", true).commit();
        ...
        edit.putInt("screen_height", metrics.heightPixels);
        edit.putInt("screen_width" , metrics.widthPixels);
        edit.commit();
